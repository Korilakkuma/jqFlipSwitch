...
p).append(k).append(m);e=e[0]}else e=void 0;d(e).off(".jq-flipswitch");d(e).on("change.jq-flipswitch",x);switch(c.type){case "click":B(e,c);break;case "flip":C(e,c)}})},option:function(d,a){if(void 0===a)return b.flipswitch.settings[d];b.flipswitch.settings[d]=a;return c.create(b.flipswitch.settings)},destroy:function(){b.flipswitch.settings={};return b.each(function(c,a){var b=null;a instanceof HTMLInputElement&&"checkbox"===a.getAttribute("type")?(b=d(a).parent(),d(a).show().insertBefore(b),b.remove()):
(b=d(a),b.removeClass("jq-flipswitch jq-flipper-left jq-flipper-right").empty())})}};if(c[String(a)])return c[String(a)].apply(this,Array.prototype.slice.call(arguments,1));if(d.isPlainObject(a)||void 0===a)return c.create(a);d.error('jquery.jqflipswitch.js : The designated method ("'+a+'") is not defined.')};d.fn.flipswitch.defaults={type:"click",width:200,height:50,init:"left",threshold:50,cursors:{normal:"pointer",flip:"ew-resize"},values:{left:!1,right:!0},texts:{left:"ON",right:"OFF"},animates:{duration:"fast",
easing:"swing"},change:function(a,b){},flipstart:function(a,b){},flip:function(a,b){},flipend:function(a,b){}};d.fn.flipswitch.settings={}})(jQuery);